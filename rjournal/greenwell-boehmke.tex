...
\CRANpkg{vita} \citep{R-vita}, \CRANpkg{rfVarImpOOB}
\citep{R-rfVarImpOOB}, \CRANpkg{randomForestExplainer}
\citep{R-randomForestExplainer}, and \CRANpkg{tree.interpreter}
