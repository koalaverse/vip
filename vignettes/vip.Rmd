...
vip(bst, num_features = 5, type = "dotplot", horizontal = FALSE, 
...
If computationally feasible, you'll want to run permutation-based importance several times and average the results. This reduces the error introduced by the randomness in the permutation procedure. You can set this via `nsim` argument:

```{r ppr-permute-nsim}
# Plot VI scores
set.seed(2021)  # for reproducibility
vip(pp, method = "permute", target = "y", metric = "rsquared", nsim = 20,
    pred_wrapper = predict, type = "boxplot", all_permutations = TRUE,
