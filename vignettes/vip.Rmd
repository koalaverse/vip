...
## `r emo::ji("warning")` Warning: This vignette is under construction! `r emo::ji("construction")` `r emo::ji("construction")` `r emo::ji("construction")` `r emo::ji("construction")`
...
vip(pp, method = "permute", obs = trn$y, metric = "rsquared",
    pred_fun = predict)
```
