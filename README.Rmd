...
You can also request the partial dependence data be returned in an attribute called `"partial"`. For example, we can see that the fitted neural network did indeed pick up the linear relationship between $x_3$ and $\mathcal{Y}$:
```{r, exampe-nn-2}
